...
public class AliyunOssUtil {
    ...
    private final static String ACCESS_KEY_ID = "LTAI4Feu8mZ3UZNXsH2JnRu9";
    private final static String ACCESS_KEY_SECRET = "TNaDBavtpOZhsDL5bZHXmieeymGNeq";
    private final static String BUCKET_NAME = "liulintao";
    private final static String BUCKET_URL = "https://liulintao.oss-cn-beijing.aliyuncs.com";
